...
This code reads one input file "integrator.in" which is a surrogate for
all the namelists and input input files a serious code might need.  What it
actually does is to calculate Y_dot for the 2D system of ODEs:
